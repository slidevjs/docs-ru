...
onMounted(() => {
  new TypeIt(block.value, {
    ...
    .type('<br><span class="token title"># Добро пожаловать в Slidev!</span><br><br>', { delay: 400 })
    ...
    .type('<span class="token title"># Страница 2</span><br><br>', { delay: 400 })
    .type('- 📄  Пишите документацию в markdown-файлах<br>', { delay: 800 })
    .type('- 🌈  Темы, блоки кода, интерактивные компоненты<br>', { delay: 800 })
    .type('- 😎  Прочтите документацию, чтобы узнать больше!', { delay: 800 })
